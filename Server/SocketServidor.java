...
//Clase principal del servidor que maneja conexiones y partidas
//Tambien administra el panel de administracion
//y la lista de clientes conectados
public class SocketServidor {    
    ...
    // Elimina un cliente de la lista y actualiza el panel de administracion
    ...
    // === METODOS PRINCIPALES ===
    // Crea una nueva partida y la agrega al mapa
    public synchronized String crearPartida(ClientHandler jugador) {
        ...
        // VERIFICACION INMEDIATA - Debug critico
        Partida verificada = partidas.get(gameId);
        System.out.println("Verificacion inmediata: " + (verificada != null ? "EXISTE" : "NO EXISTE"));
        if (verificada != null) {
    ...
    // Une un espectador a una partida existente
    ...
    public synchronized Partida obtenerPartida(String gameId) {
        ...
        if (partidas.isEmpty()) {
            System.out.println("   El mapa de partidas esta VACIO");
        } else {
        ...
        Partida partida = partidas.get(gameId);
        System.out.println("Resultado busqueda: " + (partida != null ? "ENCONTRADA" : "NO ENCONTRADA"));
        return partida;
    }
    // Obtiene la lista de partidas con informacion resumida
